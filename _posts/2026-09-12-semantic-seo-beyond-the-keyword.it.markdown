...
> Il suino nero dei Nebrodi non è un maiale da allevamento intensivo: è una razza autoctona, ufficialmente iscritta al registro anagrafico nazionale dei suini, che pascola libera nei boschi di faggio e quercia del parco dei Nebrodi, nutrendosi soprattutto di ghiande e castagne — è proprio per questo un Presidio Slow Food, con capi tenuti volutamente pochi. (Una domanda formale di DOP per la razza è al vaglio del Ministero dell'Agricoltura dal 2025 — per ora, il marchio Presidio è l'unica certificazione che esiste davvero.) Le trattorie di paese che lo cucinano davvero lo propongono come salsiccia fresca, capocollo, o il salame che qui chiamano *fellata* — mai come una generica "bistecca di maiale" sul menù plastificato. Chiedere se il suino è certificato Presidio è l'unico modo per sapere che non si sta mangiando un ibrido allevato altrove con lo stesso nome.

La seconda versione non ripete mai "suino nero dei Nebrodi" alla lettera più di una volta, ed è quella che un motore di ricerca moderno è costruito per premiare, perché dimostra davvero comprensione dell'argomento: razza iscritta al registro anagrafico, Presidio Slow Food, semibrado, capocollo, fellata, domanda di DOP. Non sono sinonimi inseriti per aggirare un sistema; sono il vocabolario che qualcuno con reale competenza sull'argomento userebbe naturalmente, e quella concentrazione di terminologia correlata e accurata è di per sé un segnale forte di profondità reale sull'argomento — la cosa che la ricerca moderna sta effettivamente cercando di misurare. (L'iscrizione ufficiale della razza e il suo allevamento semibrado, lo status di Presidio Slow Food, capocollo/fellata come suoi salumi tradizionali, e la domanda di DOP in corso sono tutti fatti reali e documentati sui Nebrodi, verificati su fonti istituzionali, non colore inventato per questo esempio — vedi le Fonti in fondo.)
...
- [Suino Nero dei Nebrodi — Parco Naturale dei Nebrodi](https://www.parcodeinebrodi.it/prodotti_dettaglio.php?id=2560) — la pagina istituzionale dell'Ente Parco dei Nebrodi sulla razza e il suo allevamento semibrado nel parco.
- [Nero dei Nebrodi](https://it.wikipedia.org/wiki/Nero_dei_Nebrodi) — l'iscrizione ufficiale della razza al registro anagrafico nazionale dei suini, gestito da ANAS ai sensi della Legge 30/1991.
- [Suino nero dei Nebrodi — Presìdi Slow Food](https://www.fondazioneslowfood.com/it/presidi-slow-food/suino-nero-dei-nebrodi/) — lo status di Presidio in sé e i salumi tradizionali (capocollo, salsiccia fresca e secca, il salame fellata) usati nell'esempio di scrittura di questo episodio.
- [Suino nero dei Nebrodi, al via l'iter per il riconoscimento del marchio Dop](https://messina.gazzettadelsud.it/articoli/societa/2025/08/07/suino-nero-dei-nebrodi-al-via-liter-per-il-riconoscimento-del-marchio-dop-521c6dd9-0924-4e3a-9c71-09f2b5576322/) — la domanda di DOP, presentata nel 2025, ancora al vaglio del Ministero al momento della scrittura (la razza **non** ha ancora lo status DOP/IGP, nonostante quanto affermano alcune fonti secondarie).
