...
> Si saltano le trattorie-trappola-per-turisti lungo Via dei Calzaiuoli. Il percorso parte dal mercato di Sant'Ambrogio, ancora frequentato ogni giorno dalle famiglie fiorentine, e attraversa cinque tappe a conduzione familiare: un carretto di lampredotto sullo stesso angolo dagli anni '80, un'enoteca che versa solo Chianti di piccoli produttori entro 20 km, e un banco di pasticceria dove i ricciarelli escono dal forno ogni mattina. Piccoli gruppi, una guida nata a Firenze, niente bus, niente cuffie.
