...
Messo insieme, ecco il cambiamento pratico: i motori di ricerca rappresentano sempre di più sia le query che i contenuti come **significato**, non come sequenze di caratteri. Sotto il cofano, questo tipicamente comporta convertire il testo in un **embedding** — una rappresentazione numerica posizionata in uno spazio dove testi che parlano di cose simili finiscono vicini tra loro, indipendentemente dal fatto che condividano le stesse parole. "Cucine a conduzione familiare nascoste tra i monti Nebrodi" e "dove mangiano davvero i nebroidensi, non il circuito degli agriturismi" possono finire vicine in quello spazio, perché *parlano* della stessa cosa, anche con quasi nessuna sovrapposizione di vocabolario. (La [serie ai-with-ruby]({% post_url 2026-08-22-semantic-search-with-pgvector %}) di questo blog costruisce esattamente questo tipo di sistema, se vuoi vedere il meccanismo dall'interno.)

È anche così che un motore di ricerca riconosce le **entità** — una persona, un luogo, un prodotto o un concetto specifico — e collega una pagina a ciò di cui parla davvero, invece che alle parole che per caso compaiono su di essa. Una pagina può posizionarsi per "consigli tour enogastronomico autentico Nebrodi" senza mai usare quella frase esatta, purché parli davvero, e in modo approfondito, di quell'argomento.

## Vedere la differenza

Una scrittura vecchio stile, guidata dalle keyword, mirata a "tour enogastronomico locale nei Nebrodi", potrebbe assomigliare a questo:

> Cerchi un tour enogastronomico locale nei Nebrodi? Il nostro tour enogastronomico locale nei Nebrodi è il miglior tour enogastronomico locale nei Nebrodi per chi vuole un tour enogastronomico locale nei Nebrodi. Prenota oggi il nostro tour enogastronomico locale nei Nebrodi!
...
> Lascia perdere gli agriturismi patinati fatti per i pullman turistici. Il percorso parte dalle faggete sopra Floresta, dove il suino nero dei Nebrodi — una razza autoctona, Presidio Slow Food — pascola ancora allo stato semibrado tra castagni e querce, e attraversa tre tappe a conduzione familiare: un allevatore che ti porta nel bosco a vedere il branco, un casaro che ancora tira a mano la Provola dei Nebrodi DOP con la *manuvedda* di legno, una tecnica tramandata di padre in figlio, e una cucina di famiglia che serve maccheroni al ferretto — pasta arrotolata a mano attorno a un ferro da calza — con un ragù fatto proprio con quel suino nero. Piccoli gruppi, una guida del posto, niente bus, niente cuffie.

La seconda versione non ripete mai "tour enogastronomico locale nei Nebrodi" alla lettera, nemmeno una volta — ed è quella che un motore di ricerca moderno è costruito per premiare, perché dimostra davvero comprensione dell'argomento: Presidio Slow Food, Provola dei Nebrodi DOP, manuvedda, maccheroni al ferretto, guida locale. Non sono sinonimi inseriti per aggirare un sistema; sono il vocabolario che qualcuno con reale competenza sull'argomento userebbe naturalmente, e quella concentrazione di terminologia correlata e accurata è di per sé un segnale forte di profondità reale sull'argomento — la cosa che la ricerca moderna sta effettivamente cercando di misurare. (Lo stato di Presidio Slow Food del suino nero allo stato semibrado, il riconoscimento DOP della Provola con i suoi strumenti tradizionali in legno, e la tecnica della pasta al ferretto sono tutti fatti reali e documentati sulla zona, non colore inventato per questo esempio — vedi le Fonti in fondo.)

## Cosa significa in pratica

Niente di tutto questo significa che le keyword abbiano smesso del tutto di contare — una pagina su un tour enogastronomico nei Nebrodi dovrebbe comunque, naturalmente, menzionare "Nebrodi" e "tour enogastronomico". Ciò che è cambiato è l'obiettivo: scrivere per coprire in modo completo e accurato un *argomento*, nel vocabolario che un esperto userebbe davvero, invece che colpire una frase specifica un numero fisso di volte. Alcune abitudini concrete che derivano direttamente da tutto questo:
...
- **Copri il vocabolario naturale che circonda l'argomento** (Presidio Slow Food, DOP, conduzione familiare, guida locale — non solo "tour enogastronomico Nebrodi" ripetuto), perché quel vocabolario è ciò che dimostra vera profondità sia a un lettore umano che a un sistema di ranking basato su embedding.
...
- [Suino nero dei Nebrodi — Presìdi Slow Food](https://www.fondazioneslowfood.com/it/presidi-slow-food/suino-nero-dei-nebrodi/) — l'allevamento semibrado del suino nero dei Nebrodi e il suo status di Presidio Slow Food.
- [Provola dei Nebrodi DOP: storia, tipologie e caratteristiche](https://www.gazzettadelgusto.it/cibo/provola-dei-nebrodi-dop-storia-tipologie-caratteristiche/) — il riconoscimento DOP del formaggio (2019) e i suoi strumenti tradizionali in legno (inclusa la manuvedda).
- [Pasta al ferretto: come si fa e ricetta dei maccheroni](https://www.agrodolce.it/pasta-al-ferretto-come-si-prepara) — la tecnica di lavorazione a mano con il ferro da calza, usata nell'esempio di scrittura di questo episodio.
