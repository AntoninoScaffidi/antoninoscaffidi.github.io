...
> Suino Nero dei Nebrodi isn't a farm-raised commodity pig — it's a native breed, officially registered on Italy's national pig herd book, that forages loose through the beech and oak forests of the Nebrodi park, living mostly on acorns and chestnuts, which is exactly why it's a Slow Food Presidium: herd sizes stay small on purpose. (A formal DOP application for the breed has been under review by Italy's Ministry of Agriculture since 2025 — for now, the Presidium mark is the only certification that actually exists.) The village trattorias that actually cook it serve it as fresh sausage, capocollo, or the salame known locally as *fellata* — never as a generic "pork chop" on a laminated menu. Ask whether the pork is Presidium-certified; it's the only way to know you're not eating a hybrid raised elsewhere under the same name.

The second version never repeats "Nebrodi black pork" verbatim more than once, and it's the one a modern search engine is built to reward, because it actually demonstrates understanding of the topic: officially registered breed, Slow Food Presidium, semi-wild, capocollo, fellata, DOP application. Those aren't synonyms inserted to game a system; they're the vocabulary someone with real expertise on the subject would naturally use, and that concentration of related, accurate terminology is itself a strong signal of genuine topical depth — the thing modern search is actually trying to measure. (The breed's official registration and semi-wild rearing, its Slow Food Presidium status, capocollo/fellata as its traditional cured products, and the pending DOP application are all real, documented facts about the Nebrodi, verified against institutional sources, not invented color for this example — see Sources below.)

## What this means in practice

None of this means keywords stopped mattering entirely — a page about Nebrodi black pork should still, naturally, mention "Nebrodi" and "black pork." What changed is the target: write to comprehensively and accurately cover a *topic*, in the vocabulary an expert on it would actually use, rather than to hit a specific phrase a fixed number of times. A few concrete habits that follow directly from everything above:
...
- **Cover the topic's natural surrounding vocabulary** (Slow Food Presidium, semi-wild, capocollo, Presidium-certified — not just "Nebrodi black pork" repeated), because that vocabulary is what demonstrates real depth to both a human reader and an embedding-based ranking system.
...
- [Suino Nero dei Nebrodi — Parco Naturale dei Nebrodi](https://www.parcodeinebrodi.it/prodotti_dettaglio.php?id=2560) — the Nebrodi Natural Park's own institutional page on the breed and its semi-wild rearing within the park.
- [Nero dei Nebrodi](https://it.wikipedia.org/wiki/Nero_dei_Nebrodi) — the breed's official registration on Italy's national pig herd book (registro anagrafico), managed by ANAS under Law 30/1991.
- [Suino nero dei Nebrodi — Slow Food Presidia](https://www.fondazioneslowfood.com/en/slow-food-presidia/black-pig-of-the-nebrodi/) — the Presidium status itself and the traditional cured products (capocollo, fresh and dried sausage, the salame called *fellata*) used in this episode's writing example.
- [Suino nero dei Nebrodi, al via l'iter per il riconoscimento del marchio Dop](https://messina.gazzettadelsud.it/articoli/societa/2025/08/07/suino-nero-dei-nebrodi-al-via-liter-per-il-riconoscimento-del-marchio-dop-521c6dd9-0924-4e3a-9c71-09f2b5576322/) — the pending DOP application, filed 2025, still under Ministry review at the time of writing (the breed does **not** currently hold DOP/IGP status, despite what some secondary sources claim).
